...
class Payments extends \Magento\Framework\Model\AbstractModel
{
    ...
    protected $_eventPrefix = 'magebay_coinpayment';
    /**
     ...
     * @var string
     */
    protected $_eventObject = 'magebay_coinpayment';
    protected $_url;
    ...
    {
        $this->_init('Magebay\CoinPayment\Model\ResourceModel\Payments');
    }
    ...
    {
        return $plural ? 'Coin Payments' : 'Coin Payments';
    }
