...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Magebay_CoinPayment::manage_payments')) {
            $this->buttonList->add(
                'saveandcontinue',
                [
    ...
    protected function _prepareLayout()
    {
        $this->_formScripts[] = "
            function toggleEditor() {
                if (tinyMCE.getInstanceById('payments_content') == null) {
                    tinyMCE.execCommand('mceAddControl', false, 'payments_content');
                } else {
                    tinyMCE.execCommand('mceRemoveControl', false, 'payments_content');
                }
            };
        ";
